...
public class Odometer extends Thread {
		...
		public static final double WR = Lab3.getWR();
		public static final double WD = Lab3.getTrack();
		...
		public void run() {
			...
			Lab3.getLeftMotor().resetTachoCount();
		    Lab3.getRightMotor().resetTachoCount();
		    lastTachoL=Lab3.getLeftMotor().getTachoCount();
		    lastTachoR=Lab3.getRightMotor().getTachoCount();

			while (true) {
				updateStart = System.currentTimeMillis();
				
				//odometer code adapted from myCourses example
				currentTachoL = Lab3.getLeftMotor().getTachoCount();
				currentTachoR = Lab3.getRightMotor().getTachoCount();
