...
/**
 * This is the main class of the first lab
 * It sets up the motors and the sensors and create instances of both type of controller
 * The user can then select which type of controller he/she wants
 * @author maxbo
 *
 */
public class WallFollowingLab {
  ...
  //creates the ultrasonic sensor and the two motors
   ...
   * Creates instances of both controllers that will be handled by their respective classes
   * @param args
   * @return void
   */
